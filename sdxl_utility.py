        ...
        if is_photographer:
            if kwargs.get("photo_type", "") != "disabled":
                ...
                if (
                    ...
                    random_value = round(self.rng.uniform(1.1, 1.5), 1)
                    # components.append(f", ({photo_type_choice}:{random_value}), ")
                    components.append(f", {photo_type_choice}, ")

            if kwargs.get("photo_framing", "") != "disabled":
                photo_framing_choice = self.get_choice(
                    kwargs.get("photo_framing", ""), PHOTO_FRAMING
                )
                if (
                    photo_framing_choice
                    and photo_framing_choice != "random"
                    and photo_framing_choice != "disabled"
                ):
                    random_value = round(self.rng.uniform(1.1, 1.5), 1)
                    components.append(f", {photo_framing_choice}, ")
...
NODE_CLASS_MAPPINGS = {
    ...
    "PromptGeneratorMity": PromptGeneratorMity,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "PromptGeneratorMity": "Auto Prompter Mity",
